...
\begin{enumerate}
    ...
    \item Perform an inverse mapping back into color space by applying the gradient descent method of Mahendran and Vedaldi. [TODO: cite paper, https://arxiv.org/abs/1412.0035]
\end{enumerate}
...
To improve the accuracy of the recognition algorithms, we used an aligned version of the dataset provided by the DFI implementation. This version of the dataset was aligned using a deep neural network and has better alignment than the ``funneled'' versions of the LFW dataset. [TODO: cite https://github.com/paulu/deepfeatinterp/issues/4]
